...
## 添加 聚合搜索 欢迎测试YYDS  上传时间：0515  21:20
## Mitv  修改更新。原TXT输出，有反馈APTV读取数据不正常，现改成纯M3U文本输出。无需重新部署操作。更新时间：0515/19:23
## Mitv 恢复正常使用 JS和变量是原来的，不用重新部署  0514  15:30更新
-----------------
## 合集升级为可自定义设定变量 更新时间 05/12  12:35
## 由于项目使用的服务器运营商跑路，使用的香港IP服务器，官方通告12号关闭。故此
所有Docker版本，和Worker版本中的  ,TXT,m3u,广东，潮州等等。暂停服务使用。 仅保留  集合.JS 继续使用(2026/05/12/10:08)
